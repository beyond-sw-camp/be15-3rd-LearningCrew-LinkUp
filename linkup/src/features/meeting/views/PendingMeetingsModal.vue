    ...
    <div class="assignment-modal">
      <div class="modal-box">
        ...
        <div class="modal-header">
          <img
            src="@/assets/icons/meeting_and_place/sidebar-pending_meetings.svg"
            alt="참가 신청 모임 목록"
            class="icon-img"
          />
          <h2>참가 신청 모임 목록</h2>
        ...
        <div class="assignment-list">
          ...
          >
            <img
              src="https://media.istockphoto.com/id/1425158165/ko/%EC%82%AC%EC%A7%84/%ED%83%81%EA%B5%AC-%ED%83%81%EA%B5%AC-%EB%9D%BC%EC%BC%93%EA%B3%BC-%EB%B8%94%EB%A3%A8-%EB%B3%B4%EB%93%9C%EC%97%90-%ED%9D%B0%EC%83%89-%EA%B3%B5.jpg?s=612x612&w=is&k=20&c=ots0jCHMDfuDpVbFLj_wI38nsMmeyyG7ETY8R3ilA8w="
              alt="썸네일"
